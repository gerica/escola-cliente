...
# ==============================================================================
# Script para Gerenciar o Serviço 'client-service'
# ==============================================================================
#
# Este script gerencia o ciclo de vida do serviço 'client-service'
# definido no docker-compose.yml do diretório atual.
#
# ==============================================================================

# --- CONFIGURAÇÃO DO PROJETO ---
# Configurações fixas para o serviço 'client-service'
